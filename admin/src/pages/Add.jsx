    ...
    e.preventDefault();
     ...
     try {
      ...
      const response = await axios.post(
        ...
        {
          headers: {
            token: token, // 👈 match backend expectation
      ...
      <div>
        ...
        <div className="flex gap-3">
          ...
          >
            <p
              className={`${
                sizes.includes("S") ? "bg-pink-900" : "bg-slate-200"
          ...
          >
            <p
              className={`${
                sizes.includes("M") ? "bg-pink-900" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              M
            </p>
          ...
          >
            <p
              className={`${
                sizes.includes("L") ? "bg-pink-900" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              L
            </p>
          ...
          >
            <p
              className={`${
                sizes.includes("XL") ? "bg-pink-900" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              XL
            </p>
          ...
          >
            <p
              className={`${
                sizes.includes("XLL") ? "bg-pink-900" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              XLL
            </p>
